...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
            ...
            {{-- <ul class="max-lg:block hidden  text-lg font-semibold flex justify-evenly items-center list-none space-x-5" > 
              <li>hot deals</li>
              <li>reviews</li>
              <li>contact</li>
              <li class="text-xl bg-blue-500 px-8 py-6 rounded-full text-white font-extrabold capitalize tracking-wider ">get your deal</li>
          </ul> --}}
            ...
            <div class="min-h-[90vh] min-w-full flex justify-center items-center bg-[#00000033]">
              <div class="w-[80%] flex p-12 pt-[120px] justify-evenly max-lg:flex-col max-[860px]:justify-center max-[860px]:items-center gap-10 max-md:w-full" >
                  ...
                  <div class="max-md:place-content-start">
                    <h4 class="text-5xl text-white mb-5  max-md:text-2xl">$469/<small class="text-sm">per person</small> </h4> 
                    <h3 class="text-6xl text-white mb-5  max-md:text-3xl">5 days 4 nights</h3>
                    <h1 class="text-8xl text-white mb-8  max-md:text-4xl">Switzerland</h1>
                  ...
                  <div class=" max-h-[300px] max-w-[500px] border-solid border-white border-2 max-md:w-full basis-48 flex justify-center items-center">
